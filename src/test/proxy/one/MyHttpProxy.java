...
public class MyHttpProxy extends Thread
{
    ...
    static public String LOGFILENAME_S="E:\\TZWY\\log_S.txt";
    static public String LOGFILENAME_C="E:\\TZWY\\log_C.txt";
    // 与客户端相连的Socket
    ...
    public void run()
    {
        ...
        try
        {
            ...
            System.out.println("wa000 : URL=" + URL);
            ...
            System.out.println("wa000 : host=" + host);
            System.out.println("wa000 : port=" + port);
        ...
        finally
        {
            ...
            catch (Exception e1)
            {
                ...
                System.out.println("e3 : " + e1.getMessage());
            }
            try
            {
                ssocket.close();
        ...
        try
        {
            ...
            while (true)
            {
                ...
                catch (Exception e)
                {
                    ...
                    {
                        System.out.println("e9 : " + ec.getMessage());
                    }

...
public class PrintTest
{
    ...
    public static void main(String[] args) throws IOException
    {
        ...
        File originalImage = new File("C:\\Users\\Administrator\\Desktop\\未命名印章.bmp");
        resize(originalImage, new File("F:\\1207-0.jpg"), 300, 0.7f);
        resize(originalImage, new File("F:\\1207-1.jpg"), 300, 1f);
    }
}
